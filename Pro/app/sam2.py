...
data_upload = "D:/SREC/Dataset_4"


loaded_model = tf.keras.models.load_model(r"D:\SREC\CNN_model\Model.h5")
...
def get_names():
    return os.listdir(r"D:\SREC\Dataset_4")
...
async def entry_in_2():
    ...
    file_path = r"D:/SREC/T5.xlsx"
    df = pd.read_excel(file_path)
    c_t = time.ctime()
    
    sheet_name = dept_name["dept"]
    ...
    # Save back to the Excel file with the given sheet name
