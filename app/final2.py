...
async def live_feed(new_user: str, dep:str):
    ...
    new_data_upload = r"D:\srec_project\project\backend_1\Dataset_5"

    cap = cv2.VideoCapture(0)  # Open webcam
    new_user_dept = r"D:\srec_project\project\backend_1\Dataset_5" + "\\" + dep
    if not os.path.exists(new_user_dept):
     os.makedirs(new_user_dept)
    model_dir = r"D:\srec_project\project\backend_1\Model" + "\\" + dep
